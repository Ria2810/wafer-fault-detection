...
if __name__=='__main__':
    try:
        path = 'C:/Users/riach/Projects/WaferFaultDetection/Prediction_Batch_files/'
        ...
        print("Prediction successful and few of the predictions are "+str(json.loads(json_predictions) ))
